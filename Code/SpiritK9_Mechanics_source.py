...
class Game:
    def __init__(self):
        ...
        self.charge_ui_rect = self.charge_ui.get_rect(center=(45, 850))
        ...
        self.dash_ui_rect = self.dash_ui.get_rect(center=(45, 750))
        ...
        self.cooldown_effect_rect = self.cooldown_effect.get_rect(center=(45,850))
        ...
        self.cooldown_effect_2_rect = self.cooldown_effect_2.get_rect(center=(45,750))
        ...
        self.frame_ui_rect = self.frame_ui.get_rect(center=(45, 850))
        ...
        self.frame_ui2_rect = self.frame_ui2.get_rect(center=(45, 750))
